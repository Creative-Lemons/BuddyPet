        ...
        <div class="card-columns">
          <div class="card shadow-lg">
            <div class="card-body card-text">
              <p class="card-title">Find your next adorable buddy</p>
              <p class="card-title-text">We will guide you through this fantastic experience of finding your best match</p>
