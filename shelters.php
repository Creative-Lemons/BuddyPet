            ...
            <div class="row pr-3">
                ...
                <div class="col border-shelter">
                    <div class="pet-info text-left p-3">
                        ...
                        <p>We help animals in need, stop animal abuse and fight for a respectful and sustainable relationship between animals, people and nature.</p>
                        <button type="button" class="btn btn-primary btn-ghost-bordered center-block">Visit site</button>
                    </div>
                </div>
            </div>
            ...
            <div class="row pr-3">
                ...
                <div class="col border-shelter">
                    <div class="pet-info text-left p-3">
                        ...
                        <p>Danish Animal Protection Aalborg's dog hotel and animal shelter have a total of 23 boxes. The dogs live in heated boxes, where most have access to their own yard.</p>
                        <button type="button" class="btn btn-primary btn-ghost-bordered center-block">Visit site</button>
                    </div>
                </div>
            </div>
