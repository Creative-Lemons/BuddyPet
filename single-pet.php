...
<body>
    ...
    <main>
        ...
        <section class="text-center pt-5 pb-2">
            <p class="title-text-pet1">- ADOPT A PET -</p>
            <p class="font-weight-bold title-text-pet">Brownie</p>
            <i class="fas fa-paw paw-title"></i>
        </section>

        <div class="container p-4 mt-3 mb-2">
            <div class="row pr-3">
                <div class="col">
                    <div>
                ...
                <div class="col ">
                    <h2 class="text-center font-weight-bold available-text">Pet Info</h2>
                    <hr>
                    <p class="font-weight-bold pet-info">Age: <a class="ml-2">2 year old</a></p>
                    <p class="font-weight-bold pet-info">Breed: <a class="ml-2">Golden Retiever</a></p>
                    <p class="font-weight-bold pet-info">Gender: <a class="ml-2">Male</a></p>
                    <p class="font-weight-bold pet-info">Personality: <a class="ml-2">Active</a></p>
                    <p class="font-weight-bold pet-info">Shelter: <a class="ml-2">Dyreværnet</a></p>
                    <p class="mt-3 font-weight-bold available-text pet-info"><i class="far fa-check-circle font-awsome mr-2"></i>Available: <a class="ml-2">Ready to adopt</a></p>
                </div>
        ...
        <section class="pt-3 pb-5 about-pet-background">
            <div class="m-4">
                <h2 class="font-weight-bold container text-left"> About Me</h2>
            </div>
            ...
            <div class="container">
                <div class="row pt-3 ">
                    <div class="col">
                        ...
                        <p>
                            Brownie basically loves all people, but has a specific side of his personality where he doesn't tolerate being pressured into something he doesn't want. 
                        </p>
                    </div>
                    <div class="col">
                        ...
                        <button type="button" class="btn btn-primary btn-ghost-bordered center-block button-pet mb-3">Adopt me</button>
                    </div>
                </div>
            </div>
        </section>
